...
def main(percentage: float, chart: str = "hot-100", autoplay: bool = True):
    ...
    print(
        f"The Number 1 song on {percentage}% through the years is {song_name} by {artist_name}."
    )
    print(
    ...
    try:
        ...
        print(
            "Please make sure that you have a Spotify account and that Spotify is open on your device."
        )
...
if __name__ == "__main__":
    percentage = float(input("How well did your model do? (Enter a percentage): "))
    print()
    main(percentage)
